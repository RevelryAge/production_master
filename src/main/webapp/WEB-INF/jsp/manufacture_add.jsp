...
<body>
	...
	<div class="one">
		...
		<div>
			<h3 class="four">添加工票</h3>
			<form action="manufacture_add" style="line-height: 50px;" method="post">

				计划详情号: <input type="number" class="form-control"
					value="planDetailId" name="planDetailId"> 
					工序号：<input
					type="number" required class="form-control"
					name="partTechnologyId"> 
					操作员id: <input type="text"
					required class="form-control" name="workStaffId"> 数量：<input
					type="number" required class="form-control" name="num">
				计划开始时间 <input class="form-control" id="datepicker2"
					readonly="readonly" name="planStartTime" type="text" required>
