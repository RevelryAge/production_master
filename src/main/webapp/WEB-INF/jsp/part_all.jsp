					...
					<c:forEach var="s" varStatus="v" items="${pageInfo.list }">
						<tr>
							...
							<td><a class="btn btn-outline-dark"
								href="part_info?id=${s.id}">查看详情</a></td>
			...
			<div class=" ">
				...
				<ul class="justify-content-center pagination">
					...
					<li class="page-item"><a class="btn btn-outline-dark"
						href="part_all?page=${pageInfo.firstPage}">第一页</a></li>
					<li class="page-item"><a class="btn btn-outline-dark"
						href="part_all?page=${pageInfo.prePage}"
						aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
							<span class="sr-only">上一页</span>
					</a></li>
					<li class="page-item"><a class="btn btn-outline-dark"
						href="part_all?page=${pageInfo.nextPage}" aria-label="Next">
