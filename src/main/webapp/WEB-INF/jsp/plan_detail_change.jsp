...
<body>
	...
	<div class="one">
		...
		<div>
			<h3 class="four">修改生产计划项</h3>
			<form action="plan_detail_change" style="line-height: 50px;" method="post">
			plan detail id: <input type="number" required readonly="readonly" class="form-control"
					 name="id" value="${planDetailId }" >
					num：<input
