...
<div class="row col-md-12 justify-content-md-center " style="">

	<div class="col-md-6 order-md-1 container">

		<h2 style="text-align: center;">员工信息</h2>
		<form class="needs-validation was-validated" action="addstaff"
			method="psot" novalidate="">
			<div class="row">
				<div class="col">
					<label for="Name" _msthash="1815554">名字</label> <input
						class="form-control" name="name" id="Name" required="" type="text"
						placeholder="" value="">
				...
				<div class="col">
					<label for="datepicker" _msthash="1456132">出生年月日</label> <input
						class="form-control" id="datepicker" name="birthday" type="text"
						required>
			...
			<div class="row">
				...
				<div class="col">
					<label for="email" _msthash="1454973">电子邮件</label> <input
						class="form-control" id="email" type="email" required name="email"
						placeholder="you@example.com you@example">
					<div class="invalid-feedback" _msthash="1334944">请为装运更新输入有效的电子邮件地址。</div>
				</div>
			</div>
			<div class="row">
				<div class="col">
					...
					<div class="invalid-feedback" _msthash="1335503">请输入您的送货地址。</div>
				</div>
			</div>
			<div class="row">
				<div class="col">
				...
				<div class="col">
					<label for="datepicker1" _msthash="1456132">加入日期</label> <input
						class="form-control" id="datepicker1" name="joinDate" type="text"
						required>
			...
			<div class="row justify-content-center">
				...
				<button class="btn btn-primary btn-lg btn-block" type="submit" _msthash="1255852">提交</button>
			</div>
	</div>
	</form>
</div>
